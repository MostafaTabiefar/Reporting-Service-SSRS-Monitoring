# Dashboard Goals
A comprehensive dashboard for monitoring reporting service performance, usage, and health.
...
### **1. Execution**
Represents an instance of a user either viewing or exporting a report.

### **2. User Count**
The distinct number of users who executed at least one report during the selected time period.

### **3. Active Dashboard**
The distinct number of reports executed by end-users within the selected time period.

### **4. Active Users**
distinct number of users who executed at least one report within the selected time period.
